...
class User(db.Model):
    ...
    groups = db.relationship(
        "Group", secondary="user_to_group", lazy="dynamic", collection_class=set
    )
...
class Child(db.Model):
    ...
    projects = db.relationship(
        "Project",
        secondary="child_to_project",
        backref="child",
        lazy="dynamic",
        collection_class=set,
    )
    godparents = db.relationship(
        "Godparent",
        secondary="child_to_godparent",
        backref="child",
        lazy="dynamic",
        collection_class=set,
    )
    ...
    def __repr__(self):
        return "<Child id=%s first_name=%s last_name=%s photo_url=%s>" % (
            self.id,
            self.first_name,
            self.last_name,
            self.photo_url,
    ...
    def projects_for_html(self):
        return [
            {"name": p.name, "selected": p in self.projects}
...
class Godparent(db.Model):
    ...
    projects = db.relationship(
        "Project",
        secondary="godparent_to_project",
        backref="godparent",
        lazy="dynamic",
        collection_class=set,
    )
